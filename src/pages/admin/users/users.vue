<template>
    <layout>
                    ...
                    <el-table-column prop="role" align="center">
                        <template #header>
                            <el-button type="success" class="w-3/4" size="large" style="font-size: 1.125rem"
                                @click="createDialog">添加账号</el-button>
                        </template>
                        <template #default="scope">
        ...
        <user-detail-dialog  :visible="detailDialogVisble" :data="tableData[detailDialogIndex]"
            @update="getUsers()"></user-detail-dialog>
        <user-change-pass-dialog :visible="changePassVisible"
            :data="tableData[changePassIndex]"></user-change-pass-dialog>
        <user-create-dialog   :visible="createUserVisible" @update="getUsers()"></user-create-dialog>
    </layout>
</template>
