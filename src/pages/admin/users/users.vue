                ...
                <el-card>
                    ...
                    >
                        <el-table-column
                            ...
                            align="center"
                        >
                            <template #default="scope" v-if="key === 'role'">
                                <el-switch
                        ...
                        <el-table-column prop="role" align="center" fixed="right" width="250">
                            <template #header>
                                <el-button
                                    type="success"
                                    class="w-3/4"
...
const selectOptions = ref<selectOptionsType[]>(['username', 'role', 'name', 'phone'])
