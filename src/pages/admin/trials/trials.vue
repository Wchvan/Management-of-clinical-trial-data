        ...
        <el-container class="w-full h-fit txl">
            <el-main>
                <el-table ref="tableRef" row-key="date" :data="trialTableData" style="width: 100%" size="large"
                    ...
                    <el-table-column v-for="item in tableLabels" :key="item" :prop="item" :label="item" align="center" width="200" />
                    <el-table-column prop="role" fixed="right" width="180" align="center">
                        ...
                        <el-button type="primary"  class="w-3/4"
                                size="large">查看详情</el-button>
                    </el-table-column>
                </el-table>
            </el-main>
        </el-container>
        <trial-create-dialog :visible="createTrialVisible" :labels="tableLabels" @update="getAllTrials"></trial-create-dialog>
    </layout>
</template>
...
// 表头
const tableLabels = ref<Array<keyof trailsType>>(['_id', '试验题目', '药物名称', '试验状态', '试验分期', '申办者', '登记日期', '企业名称', '企业联系人', '企业注册地址'])
