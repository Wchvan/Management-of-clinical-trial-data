<template>
    <el-calendar v-model="dateVal">
        <template #date-cell="{ data }">
            <div :class="[isSelect(data.day) ? 'bg-red-200' : '', data.isSelected ? 'bg-blue-400' : '']"
                @click="getSubjectInfo(data.day)" class="w-full h-full ">
                <p style="display: inline-flex;align-items: center;" :class="data.isSelected ? 'font-red' : ''">
    ...
    <revisit-subjects-dialog :visible="dialogVisible" :data="subjectInfo"></revisit-subjects-dialog>
</template>
